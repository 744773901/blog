...
public class WebsiteConfigVO {
     ...
     * ICP备案号
     */
    @JsonProperty(value = "ICPRecordNo")
    @ApiModelProperty(name = "ICPRecordNo", value = "网站备案号", required = true, dataType = "String")
    private String ICPRecordNo;

    /**
     * 公安备案号
     */
    @ApiModelProperty(name = "publicSecurityRecordNo", value = "公安备案号", required = true, dataType = "String")
