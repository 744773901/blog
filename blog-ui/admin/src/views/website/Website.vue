  ...
  <el-card class="main-card">
    <el-tabs v-model="activeName" @tab-click="handleClick">
      <el-tab-pane label="网站信息" name="info">
        <el-form :model="websiteConfigForm" label-width="100px" label-position="left">
          ...
          <el-form-item label="网站公告">
            <el-input v-model="websiteConfigForm.websiteNotice" placeholder="请输入公告内容" type="textarea" :rows="5" style="width:400px"/>
          </el-form-item>
          <el-form-item label="ICP备案号">
            <el-input v-model="websiteConfigForm.ICPRecordNo" size="small" style="width:400px"/>
          </el-form-item>
          <el-form-item label="公安备案号">
            <el-input v-model="websiteConfigForm.publicSecurityRecordNo" size="small" style="width:400px"/>
          </el-form-item>
          ...
          <el-button @click="updateWebsiteConfig" type="primary" size="medium" style="margin-left:6.3rem">修改</el-button>
        </el-form>
      </el-tab-pane>
      <el-tab-pane label="社交信息" name="notice">
        <el-form label-width="70px" :model="websiteConfigForm">
          <el-checkbox-group v-model="websiteConfigForm.socialUrlList">
            ...
            <el-button @click="updateWebsiteConfig" type="primary" size="medium" style="margin-left:4.375rem">修改</el-button>
          </el-checkbox-group>
        </el-form>
      </el-tab-pane>
      <el-tab-pane label="其他设置" name="password">
        <el-form :model="websiteConfigForm" label-width="120px" label-position="left">
...
<script>
import {getWebSiteConfig, updateWebSiteConfig} from "@/api/website";
...
export default {
  ...
  methods: {
    ...
    handleWebsiteAvatarSuccess(res) {
      this.websiteConfigForm.websiteAvatar = res.data
    },
    handleUserAvatarSuccess(res) {
      this.websiteConfigForm.userAvatar = res.data
    },
    handleTouristAvatarSuccess(res) {
      this.websiteConfigForm.touristAvatar = res.data
    },
    handleWeiXinSuccess(res) {
      this.websiteConfigForm.weiXinQRCode = res.data
    },
    handleAlipaySuccess(res) {
      this.websiteConfigForm.alipayQRCode = res.data
    },
    updateWebsiteConfig() {
